...
CREATE TABLE `studentcourse` (
  ...
  KEY `fk_cid_idx` (`CID`),
  CONSTRAINT `fk_cid` FOREIGN KEY (`CID`) REFERENCES `course` (`CID`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `studentcourse` VALUES (1,'C1'),(2,'C1'),(1,'C2'),(2,'C2'),(3,'C2');
